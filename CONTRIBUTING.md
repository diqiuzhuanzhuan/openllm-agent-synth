...
Report bugs at https://github.com/diqiuzhuanzhuan/openllm-agent-synth/issues.
...
The best way to send feedback is to file an issue at https://github.com/diqiuzhuanzhuan/openllm-agent-synth/issues.
...
Ready to contribute? Here's how to set up `openllm_agent_synth` for local development.

1. Fork the `openllm_agent_synth` repo on GitHub.
2. Clone your fork locally:

   ```sh
   git clone git@github.com:your_name_here/openllm-agent-synth.git
   ```

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed, this is how you set up your fork for local development:

   ```sh
   mkvirtualenv openllm_agent_synth
   cd openllm-agent-synth/
...
```sh
pytest tests.test_openllm_agent_synth
```
